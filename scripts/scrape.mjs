...
function buildHtml(items, newCount, timestamp) {
  ...
  <td class="actions"><input type="checkbox" class="fav-cb" data-pid="${x.propId}" aria-label="お気に入り"><button class="excl-btn" data-pid="${x.propId}" title="このリストから除外" aria-label="除外">❌</button></td>
